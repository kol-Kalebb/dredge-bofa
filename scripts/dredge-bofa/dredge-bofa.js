...
/* unused harmony import specifier */ var booleanModifier;
/* unused harmony import specifier */ var numericModifier;
/* unused harmony import specifier */ var myEffects;
/* unused harmony import specifier */ var Effect;
/* unused harmony import specifier */ var Location;
/* unused harmony import specifier */ var appearanceRates;
/* unused harmony import specifier */ var inebrietyLimit;
/* unused harmony import specifier */ var myInebriety;
/* unused harmony import specifier */ var fullnessLimit;
/* unused harmony import specifier */ var myFullness;
/* unused harmony import specifier */ var spleenLimit;
/* unused harmony import specifier */ var mySpleenUse;
/* unused harmony import specifier */ var getCampground;
/* unused harmony import specifier */ var Item;
/* unused harmony import specifier */ var getCounters;
/* unused harmony import specifier */ var totalTurnsPlayed;
/* unused harmony import specifier */ var myTurncount;
/* unused harmony import specifier */ var myFamiliar;
/* unused harmony import specifier */ var getRelated;
/* unused harmony import specifier */ var toItem;
/* unused harmony import specifier */ var toSkill;
/* unused harmony import specifier */ var toMonster;
/* unused harmony import specifier */ var myPath;
/* unused harmony import specifier */ var Path;
/* unused harmony import specifier */ var MafiaClasses;
/* unused harmony import specifier */ var getPlayerId;
/* unused harmony import specifier */ var getPlayerName;
/* unused harmony import specifier */ var mallPrice;
/* unused harmony import specifier */ var autosellPrice;
/* unused harmony import specifier */ var currentRound;
/* unused harmony import specifier */ var inMultiFight;
/* unused harmony import specifier */ var choiceFollowsFight;
/* unused harmony import specifier */ var handlingChoice;
/* unused harmony import specifier */ var elementalResistance;
/* unused harmony import specifier */ var Familiar;
/* unused harmony import specifier */ var visitUrl;
/* unused harmony import specifier */ var Slot;
/* unused harmony import specifier */ var equip;
/* unused harmony import specifier */ var equippedItem;
/* unused harmony import specifier */ var todayToString;
/* unused harmony import specifier */ var haveEffect;
/* unused harmony import specifier */ var xpath;
/* unused harmony import specifier */ var kolmafiaExtractItems;
/* unused harmony import specifier */ var batchOpen;
/* unused harmony import specifier */ var batchClose;
/* unused harmony import specifier */ var putShop;
/* unused harmony import specifier */ var repriceShop;
/* unused harmony import specifier */ var familiarWeight;
/* unused harmony import specifier */ var weightAdjustment;
/* unused harmony import specifier */ var availableAmount;
/* unused harmony import specifier */ var retrievePrice;
/* unused harmony import specifier */ var craftType;
/* unused harmony import specifier */ var isNpcItem;
/* unused harmony import specifier */ var npcPrice;
/* unused harmony import specifier */ var useFamiliar;
/* unused harmony import specifier */ var Monster;
/* unused harmony import specifier */ var logger;
/* unused harmony import specifier */ var get;
/* unused harmony import specifier */ var lib_$skill;
/* unused harmony import specifier */ var lib_$items;
/* unused harmony import specifier */ var lib_$familiar;
/* unused harmony import specifier */ var lib_$item;
/* unused harmony import specifier */ var lib_$effect;
/* unused harmony import specifier */ var lib_chunk;
/* unused harmony import specifier */ var lib_notNull;
/* unused harmony import specifier */ var lib_clamp;
/* unused harmony import specifier */ var lib_tuple;
...
var banishSource = banisher => {
  switch (banisher.toLowerCase()) {
    case "saber force":
      return lib_$skill(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Use the Force"])));
    case "nanorhino":
      return lib_$skill(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Unleash Nanites"])));
    case "sea *dent":
      return lib_$skill(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["Sea *dent: Throw a Lightning Bolt"])));
  }
  var item = toItem(banisher);
  if (lib_$items(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["none, training scroll:  Snokebomb, tomayohawk-style reflex hammer"]))).includes(item)) {
...
function multiSplit(prop, outerDelimiter, innerDelimiter, mappers) {
  ...
  var multiDimensionalArray = outerDelimiter === innerDelimiter ? lib_chunk(initialSplit, mappers.length) : initialSplit.map(entry => entry.split(innerDelimiter));
...
function canUse(item) {
  ...
  if (path !== Path.get("Nuclear Autumn")) {
    if (lib_$items(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["Shrieking Weasel holo-record, Power-Guy 2000 holo-record, Lucky Strikes holo-record, EMD holo-record, Superdrifter holo-record, The Pigs holo-record, Drunk Uncles holo-record"]))).includes(item)) {
      return false;
    }
  }
...
var Environment = (/* unused pure expression or super */ null && ({
  Outdoor: "outdoor",
  Indoor: "indoor",
...
function findLeprechaunMultiplier(familiar) {
  if (familiar === lib_$familiar(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["Mutant Cactus Bud"])))) {
    return numericModifier(familiar, "Leprechaun Effectiveness", 1, lib_$item.none);
  }
  if (familiar === lib_$familiar(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["Reanimated Reanimator"])))) return 0;
  var meatBonus = numericModifier(familiar, "Meat Drop", 1, lib_$item.none);
...
function findFairyMultiplier(familiar) {
  if (familiar === lib_$familiar(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["Mutant Fire Ant"])))) {
    return numericModifier(familiar, "Fairy Effectiveness", 1, lib_$item.none);
  }
  if (familiar === lib_$familiar(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["Reanimated Reanimator"])))) return 0;
  var itemBonus = numericModifier(familiar, "Item Drop", 1, lib_$item.none);
  if (itemBonus === 0) return 0;
  // Assumes you're using LED candle; returns effective weight multiplier
  if (familiar === lib_$familiar(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["Jill-of-All-Trades"])))) return 1.5;
...
function unequip(thing) {
  if (thing instanceof Slot) return equip(thing, lib_$item.none);
...
function freeCrafts() {
  ...
  var all = (have(lib_$skill(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["Rapid Prototyping"])))) ? 5 - get("_rapidPrototypingUsed") : 0) + (have(lib_$skill(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["Expert Corner-Cutter"])))) ? 5 - get("_expertCornerCutterUsed") : 0) + effectCrafts(lib_$effect(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["Inigo's Incantation of Inspiration"])))) + effectCrafts(lib_$effect(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["Craft Tea"])))) + effectCrafts(lib_$effect(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["Cooking Concentrate"]))));
...
function realmCurrency(realm) {
  switch (realm) {
    case "sleaze":
      return lib_$item(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["Beach Buck"])));
    case "spooky":
      return lib_$item(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["Coinspiracy"])));
    case "stench":
      return lib_$item(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["FunFunds\u2122"])));
    case "cold":
      return lib_$item(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["Wal-Mart gift certificate"])));
    case "hot":
      return lib_$item(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["Volcoino"])));
    case "fantasy":
      return lib_$item(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["Rubee\u2122"])));
    case "cyber":
      return lib_$item(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["0"])));
    default:
      return null;
  }
}
...
function lgrCurrencies() {
  return realmTypes.filter(realm => realmAvailable(realm) && !(realm === "sleaze" && get("_luckyGoldRingBeachBuck") >= 25) && !(realm === "spooky" && get("_luckyGoldRingCoinspiracy") >= 25) && !(realm === "stench" && get("_luckyGoldRingFunFunds") >= 15) && !(realm === "cold" && get("_luckyGoldRingWalmart") >= 15) && !(realm === "hot" && get("_luckyGoldRingVolcoino") >= 2) && !(realm === "fantasy" && get("_luckyGoldRingRubee") >= 10) && !(realm === "cyber" && get("_luckyGoldRingBit") >= 10)).map(realmCurrency).filter(lib_notNull);
}
...
function totalFamiliarWeight() {
  ...
  return lib_clamp(lib_clamp(familiarWeight(familiar), have(lib_$effect(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["Fidoxene"])))) ? 20 : 0, Infinity) + familiar.soupWeight + (considerAdjustment ? weightAdjustment() : 0) + (familiar.feasted ? 10 : 0), 1, Infinity);
}
...
var SPECIAL_ULTS = new Map([[$familiar(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["Nursine"]))), ["ult_bearhug"]], [$familiar(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["Caramel"]))), ["ult_sticktreats"]], [$familiar(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["Smashmoth"]))), ["ult_owlstare"]], [$familiar(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["Slotter"]))), ["ult_bloodbath"]], [$familiar(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["Cornbeefadon"]))), ["ult_pepperscorn"]], [$familiar(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["Mu"]))), ["ult_rainbowstorm"]]]);
/**
...
function getAcquirePrice(item) {
  ...
  if (item.tradeable) {
    if (mallPrice(item) === mallMinPrice) {
      ...
      return lib_clamp(currentAmount, 0, quantity) * autosellPrice(item) + amountNeeded * mallPrice(item);
    }
    if (mallPrice(item) > mallMinPrice) {
...
function adventureTargetToWeightedMap(target) {
  ...
  if (target instanceof Location) {
    return new Map(Object.entries(appearanceRates(target, true)).map(_ref15 => {
      var _ref16 = lib_slicedToArray(_ref15, 2),
        monster = _ref16[0],
        rate = _ref16[1];
      return lib_tuple(toMonster(monster), rate / 100);
    }).filter(_ref17 => {
...
var overlappingItemNames = new Set(["spider web", "really sticky spider web", "dictionary", "NG", "Cloaca-Cola", "yo-yo", "top", "ball", "kite", "yo", "red potion", "blue potion", "bowling ball", "adder", "red button", "tennis ball", "pile of sand", "mushroom", "deluxe mushroom", "spoon"]);
var overlappingSkillNames = new Set(["Lightning Bolt", "Shoot", "Thrust-Smack", "Headbutt", "Toss", "Knife in the Dark", "Sing", "Disarm", "Static Shock", "LIGHT", "BURN", "Extract", "Meteor Shower", "Snipe", "Bite", "Kick", "Punt", "Howl", "Cleave", "Boil", "Slice", "Rainbow"]);
...
/* unused harmony import specifier */ var property_isNumericProperty;
...
function increment(property) {
  ...
  if (!property_isNumericProperty(property)) return value;
...
/* unused harmony import specifier */ var setAutoAttack;
/* unused harmony import specifier */ var adv1;
/* unused harmony import specifier */ var combat_inMultiFight;
/* unused harmony import specifier */ var runCombat;
/* unused harmony import specifier */ var combat_choiceFollowsFight;
/* unused harmony import specifier */ var combat_visitUrl;
...
function itemOrItemsBallsMacroName(itemOrItems) {
  if (Array.isArray(itemOrItems)) {
    ...
    return !overlappingItemNames.has(item.name) ? item.name : item.id.toFixed(0);
  }
}
/**
...
var Macro = /*#__PURE__*/function () {
  ...
  return combat_createClass(Macro, [{
     ...
     */
    function icon(item) {
      return this.step("icon ".concat(item.image.replace(/\.[^.]+$/, "")));
    }
    /**
     * Add an "icon [image]" step to this macro.
     *
     ...
     * @returns {Macro} This object itself.
     */
    function if_(condition, ifTrue, ifFalse) {
      this.step("if ".concat(Macro.makeBALLSPredicate(condition))).step(ifTrue);
      if (ifFalse) {
     ...
     * @returns {Macro} This object itself.
     */
    function ifNot(condition, ifTrue, ifFalse) {
      return this.if_("!".concat(Macro.makeBALLSPredicate(condition)), ifTrue, ifFalse);
    }
    /**
     ...
     * @returns {Macro} This object itself.
     */
    function itemQueue(items, condition) {
      var single = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      if (items.length === 0) return this;
      return this.step("".concat(single ? "usesinglequeue" : "usequeue", " ").concat(condition ? "until ".concat(Macro.makeBALLSPredicate(condition), " :: ") : "").concat(items.slice(0, 20).map(itemOrItemsBallsMacroName).join(", "))).itemQueue(items.slice(20), condition);
    }
    /**
     * Create a new macro with one or more item queue steps.
     * Items will be funkslinged if available.
     ...
     */
    function beginif(condition, ifTrue) {
    ...
    value: function makeBALLSPredicate(condition) {
      ...
      } else if (["indoor", "outdoor", "underground", "underwater", "none"].includes(condition)) {
    ...
    key: "if_",
    value: function if_(condition, ifTrue, ifFalse) {
      return new this().if_(condition, ifTrue, ifFalse);
    }
  }, {
    key: "ifNot",
    value: function ifNot(condition, ifTrue, ifFalse) {
    ...
    key: "itemQueue",
    value: function itemQueue(items, condition) {
      var single = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    key: "beginif",
    value: function beginif(condition, ifTrue) {
...
function adventureMacro(loc, macro) {
  ...
  try {
    adv1(loc, 0, "");
    while (combat_inMultiFight()) runCombat();
    if (combat_choiceFollowsFight()) combat_visitUrl("choice.php");
  } finally {
    Macro.clearSaved();
  }
}
...
var MacroIfBlock = /*#__PURE__*/function () {
  function MacroIfBlock(macro, condition, ifTrue) {
    combat_classCallCheck(this, MacroIfBlock);
    combat_defineProperty(this, "root", void 0);
    combat_defineProperty(this, "components", []);
    combat_defineProperty(this, "baseClass", void 0);
    this.root = macro;
    this.baseClass = this.root.constructor;
    this.append(this.baseClass.if_(condition, ifTrue));
    this.components.pop(); // Remove "endif";
  }
  return combat_createClass(MacroIfBlock, [{
    key: "append",
    value: function append() {
      var _this$components2;
      for (var _len13 = arguments.length, components = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
        components[_key13] = arguments[_key13];
      }
      (_this$components2 = this.components).push.apply(_this$components2, combat_toConsumableArray(components.flatMap(component => component instanceof Macro ? component.components : component)));
      return this;
    }
    /**
    ...
    key: "elseIf",
    value: function elseIf(condition, macro) {
    ...
    value: function endif() {
      var _this$root;
      return (_this$root = this.root).step.apply(_this$root, combat_toConsumableArray(this.components)).step("endif");
    }
    /**
...
var modeableItems = {
  ...
  jillcandle: $item(maximize_templateObject7 || (maximize_templateObject7 = maximize_taggedTemplateLiteral(["LED candle"])))
};
var modeableState = {
...
function applyCached(entry, options) {
  ...
  if ((0,external_kolmafia_namespaceObject.equippedAmount)($item(maximize_templateObject10 || (maximize_templateObject10 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) > 0 && entry.rider.get($item(maximize_templateObject11 || (maximize_templateObject11 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))))) {
    (0,external_kolmafia_namespaceObject.enthroneFamiliar)(entry.rider.get($item(maximize_templateObject12 || (maximize_templateObject12 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) || $familiar.none);
  }
  if ((0,external_kolmafia_namespaceObject.equippedAmount)($item(maximize_templateObject13 || (maximize_templateObject13 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) > 0 && entry.rider.get($item(maximize_templateObject14 || (maximize_templateObject14 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
    (0,external_kolmafia_namespaceObject.bjornifyFamiliar)(entry.rider.get($item(maximize_templateObject15 || (maximize_templateObject15 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) || $familiar.none);
  }
...
function verifyCached(entry) {
  ...
  if ((0,external_kolmafia_namespaceObject.equippedAmount)($item(maximize_templateObject23 || (maximize_templateObject23 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) > 0 && entry.rider.get($item(maximize_templateObject24 || (maximize_templateObject24 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))))) {
    if (entry.rider.get($item(maximize_templateObject25 || (maximize_templateObject25 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) !== (0,external_kolmafia_namespaceObject.myEnthronedFamiliar)()) {
      if (warn) {
        dist_logger.warning("Failed to apply ".concat(entry.rider.get($item(maximize_templateObject26 || (maximize_templateObject26 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))), " in ").concat($item(maximize_templateObject27 || (maximize_templateObject27 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))), "."));
      }
      success = false;
    }
  }
  if ((0,external_kolmafia_namespaceObject.equippedAmount)($item(maximize_templateObject28 || (maximize_templateObject28 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) > 0 && entry.rider.get($item(maximize_templateObject29 || (maximize_templateObject29 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
    if (entry.rider.get($item(maximize_templateObject30 || (maximize_templateObject30 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) !== (0,external_kolmafia_namespaceObject.myBjornedFamiliar)()) {
      if (warn) {
        dist_logger.warning("Failed to apply".concat(entry.rider.get($item(maximize_templateObject31 || (maximize_templateObject31 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))), " in ").concat($item(maximize_templateObject32 || (maximize_templateObject32 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))), "."));
      }
      success = false;
    }
  }
...
function saveCached(cacheKey, options) {
  ...
  if ((0,external_kolmafia_namespaceObject.equippedAmount)($item(maximize_templateObject33 || (maximize_templateObject33 = maximize_taggedTemplateLiteral(["card sleeve"])))) > 0) {
  ...
  if ((0,external_kolmafia_namespaceObject.equippedAmount)($item(maximize_templateObject36 || (maximize_templateObject36 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) > 0) {
    rider.set($item(maximize_templateObject37 || (maximize_templateObject37 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))), (0,external_kolmafia_namespaceObject.myEnthronedFamiliar)());
  }
  if ((0,external_kolmafia_namespaceObject.equippedAmount)($item(maximize_templateObject38 || (maximize_templateObject38 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) > 0) {
    rider.set($item(maximize_templateObject39 || (maximize_templateObject39 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))), (0,external_kolmafia_namespaceObject.myBjornedFamiliar)());
  }
  if (options.preventSlot && options.preventSlot.length > 0) {
    ...
    if (options.preventSlot.includes($slot(maximize_templateObject40 || (maximize_templateObject40 = maximize_taggedTemplateLiteral(["buddy-bjorn"]))))) {
      rider.delete($item(maximize_templateObject41 || (maximize_templateObject41 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))));
    }
    if (options.preventSlot.includes($slot(maximize_templateObject42 || (maximize_templateObject42 = maximize_taggedTemplateLiteral(["crown-of-thrones"]))))) {
      rider.delete($item(maximize_templateObject43 || (maximize_templateObject43 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))));
    }
  }
  if (options.onlySlot && options.onlySlot.length > 0) {
    ...
    if (!options.onlySlot.includes($slot(maximize_templateObject44 || (maximize_templateObject44 = maximize_taggedTemplateLiteral(["buddy-bjorn"]))))) {
      rider.delete($item(maximize_templateObject45 || (maximize_templateObject45 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))));
    }
    if (!options.onlySlot.includes($slot(maximize_templateObject46 || (maximize_templateObject46 = maximize_taggedTemplateLiteral(["crown-of-thrones"]))))) {
      rider.delete($item(maximize_templateObject47 || (maximize_templateObject47 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))));
    }
  }
...
var Outfit = /*#__PURE__*/function () {
  ...
  return outfit_createClass(Outfit, [{
    ...
    value: function equipNonAccessory(item, slot) {
      ...
      if ((0,external_kolmafia_namespaceObject.toSlot)(item) !== $slot(outfit_templateObject8 || (outfit_templateObject8 = outfit_taggedTemplateLiteral(["familiar"]))) && !(0,external_kolmafia_namespaceObject.canEquip)(item)) return false;
    ...
    value: function equipAccessory(item, slot) {
      ...
      if ((0,external_kolmafia_namespaceObject.toSlot)(item) !== $slot(outfit_templateObject0 || (outfit_templateObject0 = outfit_taggedTemplateLiteral(["acc1"])))) return false;
      if (!(0,external_kolmafia_namespaceObject.canEquip)(item)) return false;
      if (slot === undefined) {
        // We don't care which of the accessory slots we equip in
        var empty = $slots(outfit_templateObject1 || (outfit_templateObject1 = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"]))).find(s => !this.equips.has(s));
    ...
    value: function equipUsingDualWield(item, slot) {
      ...
      if (!(0,external_kolmafia_namespaceObject.canEquip)(item)) return false;
      if (!weaponsCompatible(this.equips.get($slot(outfit_templateObject16 || (outfit_templateObject16 = outfit_taggedTemplateLiteral(["weapon"])))), item)) return false;
      this.equips.set($slot(outfit_templateObject17 || (outfit_templateObject17 = outfit_taggedTemplateLiteral(["off-hand"]))), item);
      return true;
    }
  }, {
    ...
    value: function getHoldingFamiliar(item) {
      switch ((0,external_kolmafia_namespaceObject.toSlot)(item)) {
        case $slot(outfit_templateObject18 || (outfit_templateObject18 = outfit_taggedTemplateLiteral(["weapon"]))):
          return $familiar(outfit_templateObject19 || (outfit_templateObject19 = outfit_taggedTemplateLiteral(["Disembodied Hand"])));
        case $slot(outfit_templateObject20 || (outfit_templateObject20 = outfit_taggedTemplateLiteral(["off-hand"]))):
          return $familiar(outfit_templateObject21 || (outfit_templateObject21 = outfit_taggedTemplateLiteral(["Left-Hand Man"])));
        case $slot(outfit_templateObject22 || (outfit_templateObject22 = outfit_taggedTemplateLiteral(["pants"]))):
          return $familiar(outfit_templateObject23 || (outfit_templateObject23 = outfit_taggedTemplateLiteral(["Fancypants Scarecrow"])));
        case $slot(outfit_templateObject24 || (outfit_templateObject24 = outfit_taggedTemplateLiteral(["hat"]))):
          return $familiar(outfit_templateObject25 || (outfit_templateObject25 = outfit_taggedTemplateLiteral(["Mad Hatrack"])));
        default:
          return undefined;
      }
    }
    ...
    value: function equipUsingFamiliar(item, slot) {
      if (![undefined, $slot(outfit_templateObject26 || (outfit_templateObject26 = outfit_taggedTemplateLiteral(["familiar"])))].includes(slot)) return false;
      if (this.equips.has($slot(outfit_templateObject27 || (outfit_templateObject27 = outfit_taggedTemplateLiteral(["familiar"]))))) return false;
      ...
      if (familiar === undefined || $familiars(outfit_templateObject28 || (outfit_templateObject28 = outfit_taggedTemplateLiteral(["Fancypants Scarecrow, Mad Hatrack"]))).includes(familiar) && slot === undefined) {
        return false;
      }
      if (!this.equip(familiar)) return false;
      this.equips.set($slot(outfit_templateObject29 || (outfit_templateObject29 = outfit_taggedTemplateLiteral(["familiar"]))), item);
      return true;
    }
  }, {
    key: "equipItem",
    ...
    value: function equipFamiliar(familiar) {
      ...
      var item = this.equips.get($slot(outfit_templateObject30 || (outfit_templateObject30 = outfit_taggedTemplateLiteral(["familiar"]))));
      if (item !== undefined && item !== $item.none && !(0,external_kolmafia_namespaceObject.canEquip)(familiar, item)) return false;
      this.familiar = familiar;
      return true;
    }
  }, {
    ...
    value: function equipSpec(spec) {
      ...
      for (var _i = 0, _outfitSlots = outfitSlots; _i < _outfitSlots.length; _i++) {
        ...
        var slot = (_a = new Map([["famequip", $slot(outfit_templateObject31 || (outfit_templateObject31 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(outfit_templateObject32 || (outfit_templateObject32 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_namespaceObject.toSlot)(slotName);
    ...
    value: function bjornify(target) {
      return this.equipRider(target, $slot(outfit_templateObject33 || (outfit_templateObject33 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
    }
    /**
    ...
    value: function enthrone(target) {
      return this.equipRider(target, $slot(outfit_templateObject34 || (outfit_templateObject34 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
    }
    /**
    ...
    value: function _dress(refreshed) {
      ...
      if (weaponHands((0,external_kolmafia_namespaceObject.equippedItem)($slot(outfit_templateObject48 || (outfit_templateObject48 = outfit_taggedTemplateLiteral(["weapon"]))))) !== 1 && this.equips.has($slot(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["offhand"])))) && !this.equips.has($slot(outfit_templateObject50 || (outfit_templateObject50 = outfit_taggedTemplateLiteral(["weapon"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(outfit_templateObject51 || (outfit_templateObject51 = outfit_taggedTemplateLiteral(["weapon"]))), $item.none);
      // 2. An existing dual-fisted ranged weapon would block melee weapons.
      if (!weaponsCompatible(this.equips.get($slot(outfit_templateObject52 || (outfit_templateObject52 = outfit_taggedTemplateLiteral(["weapon"])))), (0,external_kolmafia_namespaceObject.equippedItem)($slot(outfit_templateObject53 || (outfit_templateObject53 = outfit_taggedTemplateLiteral(["off-hand"])))))) (0,external_kolmafia_namespaceObject.equip)($slot(outfit_templateObject54 || (outfit_templateObject54 = outfit_taggedTemplateLiteral(["off-hand"]))), $item.none);
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          if (targetEquipment.includes((0,external_kolmafia_namespaceObject.equippedItem)(slot)) && this.equips.get(slot) !== (0,external_kolmafia_namespaceObject.equippedItem)(slot) || this.avoid.includes((0,external_kolmafia_namespaceObject.equippedItem)(slot))) (0,external_kolmafia_namespaceObject.equip)(slot, $item.none);
        }
      ...
      var accessorySlots = $slots(_templateObject55 || (_templateObject55 = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"])));
      ...
      if (bjorn && (0,external_kolmafia_namespaceObject.haveEquipped)($item(_templateObject56 || (_templateObject56 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
      ...
      if (crown && (0,external_kolmafia_namespaceObject.haveEquipped)($item(_templateObject57 || (_templateObject57 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) {
      ...
      for (var _i4 = 0, _arr = [[$slot(_templateObject58 || (_templateObject58 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))), $item(_templateObject59 || (_templateObject59 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))), external_kolmafia_namespaceObject.myBjornedFamiliar], [$slot(_templateObject60 || (_templateObject60 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))), $item(_templateObject61 || (_templateObject61 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))), external_kolmafia_namespaceObject.myEnthronedFamiliar]]; _i4 < _arr.length; _i4++) {
    ...
    value: function spec() {
      ...
      for (var _i5 = 0, _outfitSlots2 = outfitSlots; _i5 < _outfitSlots2.length; _i5++) {
        ...
        var entry = this.equips.get((_a = new Map([["famequip", $slot(_templateObject62 || (_templateObject62 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(_templateObject63 || (_templateObject63 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_namespaceObject.toSlot)(slotName));
        if (entry) result[slotName] = entry;
      }
      // Include the riders
      var riders = {};
      var buddyRider = this.riders.get($slot(_templateObject64 || (_templateObject64 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
      if (buddyRider !== undefined) riders["buddy-bjorn"] = buddyRider;
      var throneRider = this.riders.get($slot(_templateObject65 || (_templateObject65 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
    ...
    value: function current() {
      ...
      if ((0,external_kolmafia_namespaceObject.haveEquipped)($item(_templateObject68 || (_templateObject68 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) outfit.riders.set($slot(_templateObject69 || (_templateObject69 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))), (0,external_kolmafia_namespaceObject.myEnthronedFamiliar)());
      if ((0,external_kolmafia_namespaceObject.haveEquipped)($item(_templateObject70 || (_templateObject70 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) outfit.riders.set($slot(_templateObject71 || (_templateObject71 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))), (0,external_kolmafia_namespaceObject.myBjornedFamiliar)());
...
function weaponsCompatible(weapon, offhand) {
  if (!weapon || weapon === $item(_templateObject72 || (_templateObject72 = outfit_taggedTemplateLiteral(["none"])))) return true;
  if (!offhand || offhand === $item(_templateObject73 || (_templateObject73 = outfit_taggedTemplateLiteral(["none"])))) return true;
  if ((0,external_kolmafia_namespaceObject.toSlot)(offhand) !== $slot(_templateObject74 || (_templateObject74 = outfit_taggedTemplateLiteral(["weapon"])))) return true;
  var weaponStat = (0,external_kolmafia_namespaceObject.weaponType)(weapon);
  var offhandStat = (0,external_kolmafia_namespaceObject.weaponType)(offhand);
  if (weaponStat === $stat(_templateObject75 || (_templateObject75 = outfit_taggedTemplateLiteral(["Moxie"]))) && (offhandStat === $stat(_templateObject76 || (_templateObject76 = outfit_taggedTemplateLiteral(["Mysticality"]))) || offhandStat === $stat(_templateObject77 || (_templateObject77 = outfit_taggedTemplateLiteral(["Muscle"]))))) return false;
  if (offhandStat === $stat(_templateObject78 || (_templateObject78 = outfit_taggedTemplateLiteral(["Moxie"]))) && (weaponStat === $stat(_templateObject79 || (_templateObject79 = outfit_taggedTemplateLiteral(["Mysticality"]))) || weaponStat === $stat(_templateObject80 || (_templateObject80 = outfit_taggedTemplateLiteral(["Muscle"]))))) return false;
  return true;
}
...
function engine_possibleConstructorReturn(t, e) { if (e && ("object" == engine_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return engine_assertThisInitialized(t); }
...
var ContextualEngine = /*#__PURE__*/function () {
  ...
  return engine_createClass(ContextualEngine, [{
    ...
    value: function setCombat(task, task_combat, task_resources) {
      ...
      var macro = task_combat.compile(task_resources, (_a = this.options) === null || _a === void 0 ? void 0 : _a.combat_defaults, task.do instanceof external_kolmafia_namespaceObject.Location ? task.do : undefined, this.getContext(task));
      macro.save();
      if (!this.options.ccs) {
...
/* unused harmony import specifier */ var getRevision;
/* unused harmony import specifier */ var getVersion;
...
var args = Args.create("Dredge Bofa Seeds", "A script for finding seeds for a particular fact. Provide one item or effect and at least one of the following: monster, class, or path.", {
...
function main(command) {
  ...
  if (args.effect && args.item) {
    (0,external_kolmafia_namespaceObject.abort)("I'm useful, but not that clever. Please provide only one item or effect to dredge for.");
  }
  var fact = (_args$effect = args.effect) !== null && _args$effect !== void 0 ? _args$effect : args.item;
  if (!fact) {
    (0,external_kolmafia_namespaceObject.abort)("You need to give me something to work with here. Please provide an item or effect to dredge for.");
  }
  var noPathsMobsClassWarning = !args.path && !args.class && !args.monster;
  if (noPathsMobsClassWarning) {
    (0,external_kolmafia_namespaceObject.abort)("You are looking for all the needles Frank. Try limiting your search by something before you break something.");
  }
  var mobNote = args.monster ? ", on ".concat(args.monster) : "";
  var pathNote = args.path ? ", in ".concat(args.path) : "";
  var classNote = args.class ? ", as a ".concat(args.class) : "";
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var pth = _step.value;
      var _iterator2 = main_createForOfIteratorHelper(testClasses),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          var _iterator3 = main_createForOfIteratorHelper(testMonster),
            _step3;
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
  ...
  ;(0,external_kolmafia_namespaceObject.print)();
  (0,external_kolmafia_namespaceObject.print)("Done dredging bofa seeds.");
  (0,external_kolmafia_namespaceObject.print)();
}
